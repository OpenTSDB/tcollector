...
TCollector plugin to get metrics from Hadoop Yarn Node Manager JMX API
...
class HadoopYarnNodeManager(HadoopHttp):
  ...
  """
    ...
    def __init__(self, host="localhost", port=8042):
        super(HadoopYarnNodeManager, self).__init__("hadoop", "yarn.node_manager", host, port)
...
def main(args):
    ...
    parser.add_argument("-H", "--host", default="localhost", help="Host to connect to (default: localhost)")
    parser.add_argument("-P", "--port", default=8042, type=int, help="Port to connect to (default: 8042)")
    parser.add_argument("-i", "--interval", default=90, type=int, help="Interval at which to emit metrics")
