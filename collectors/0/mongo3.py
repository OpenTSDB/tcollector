...
CONFIG_LOCKS_METRICS = ("locks.Collection.acquireCount", "locks.Database.acquireCount", "locks.Global.acquireCount", "locks.MMAPV1Journal.acquireCount", "locks.MMAPV1Journal.acquireWaitCount", "locks.MMAPV1Journal.timeAcquiringMicros", "locks.Metadata.acquireCount")

MONGOS_METRICS = ("objects", "avgObjSize", "dataSize", "storageSize", "numExtents", "indexes", "indexSize", "fileSize", "extentFreeList.num", "extentFreeList.totalSize")

MONGOS_RAW_METRICS = ("collections", "objects", "avgObjSize", "dataSize", "storageSize", "numExtents", "indexes", "indexSize", "fileSize")

REPLICA_METRICS = ("pingMs", "uptime")
