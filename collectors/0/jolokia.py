...
class JolokiaCollector():
    ...
    def __init__(self, url, tags, monitors):
        """
    ...
    def _set_monitors(self, monitors, tags):
        ...
        for m in monitors:
            ...
            # set a defaul not_tags to '' to catch empty tag keys and append
...
def main():
    ...
    for instance in CONFIG['instances']:
        ...
        jc = JolokiaCollector(instance['url'], instance['tags'], instance['monitors'])
        instances.append(jc)
