...
def main():
    ...
    while signal_received is None:
        ...
        print "disk.b.read %s %s disk=%s" % (timestamp, float(fields[3])*1024, fields[17])
        print "disk.bps.read %s %s disk=%s" % (timestamp, float(fields[4])*1024, fields[17])
        print "disk.ms.read %s %s disk=%s" % (timestamp, fields[5], fields[17])
        print "disk.ops.write %s %s disk=%s" % (timestamp, fields[6], fields[17])
        print "disk.b.write %s %s disk=%s" % (timestamp, float(fields[7])*1024, fields[17])
        print "disk.bps.write %s %s disk=%s" % (timestamp, float(fields[8])*1024, fields[17])
        print "disk.ms.write %s %s disk=%s" % (timestamp, fields[9], fields[17])
        print "disk.ops.delete %s %s disk=%s" % (timestamp, fields[10], fields[17])
        print "disk.b.delete %s %s disk=%s" % (timestamp, float(fields[11])*1024, fields[17])
        print "disk.bps.delete %s %s disk=%s" % (timestamp, float(fields[12])*1024, fields[17])
        print "disk.ms.delete %s %s disk=%s" % (timestamp, fields[13], fields[17])
