...
def main():
    ...
    while signal_received is None:
        ...
        print "disk.b.read %s %s disk=%s" % (timestamp, fields[3], fields[17])
        print "disk.bps.read %s %s disk=%s" % (timestamp, fields[4], fields[17])
        print "disk.ms.read %s %s disk=%s" % (timestamp, fields[5], fields[17])
        print "disk.ops.write %s %s disk=%s" % (timestamp, fields[6], fields[17])
        print "disk.b.write %s %s disk=%s" % (timestamp, fields[7], fields[17])
        print "disk.bps.write %s %s disk=%s" % (timestamp, fields[8], fields[17])
        ...
        print "disk.b.delete %s %s disk=%s" % (timestamp, fields[11], fields[17])
        print "disk.bps.delete %s %s disk=%s" % (timestamp, fields[12], fields[17])
