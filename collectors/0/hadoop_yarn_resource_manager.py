...
class HadoopYarnResourceManager(HadoopHttp):
  ...
  """
    ...
    def __init__(self, host="localhost", port=8088):
        super(HadoopYarnResourceManager, self).__init__("hadoop", "yarn.resource_manager", host, port)
...
def main(args):
    ...
    parser.add_argument("-P", "--port", default=8088, type=int, help="Port to connect to (default: 8088)")
