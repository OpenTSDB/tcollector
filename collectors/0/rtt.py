...
"""
About The PROGRAM : THe Following Python Program checks the Ping Time from your system
[where you are running the tcollector] and to the
...
Sample Config File DOES NOT exists.
 """
...
"""
    ...
    June 23, 2015
    ----------------
    Required modules imported (to send data to TSDB)
    and the print() function as per OPENTSDB format
    to send data to the TSDB.
    - Aniket Maithani
